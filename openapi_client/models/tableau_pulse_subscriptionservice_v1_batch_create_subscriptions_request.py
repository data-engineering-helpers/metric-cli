...
class TableauPulseSubscriptionserviceV1BatchCreateSubscriptionsRequest(BaseModel):
    """
    TableauPulseSubscriptionserviceV1BatchCreateSubscriptionsRequest
    """ # noqa: E501
    metric_id: Optional[StrictStr] = None
    followers: Optional[List[TableauPulseSubscriptionserviceTypesV1Follower]] = None
    __properties: ClassVar[List[str]] = ["metric_id", "followers"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "followers": [TableauPulseSubscriptionserviceTypesV1Follower.from_dict(_item) for _item in obj["followers"]] if obj.get("followers") is not None else None
        })
        return _obj
