...
class TableauPulseSubscriptionserviceV1UpdateUserPreferencesRequest(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["cadence", "channel_preferences_request", "metric_grouping_preferences"]
