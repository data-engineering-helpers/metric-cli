...
class TableauMetricqueryserviceTypesV1VizStateSpecification(BaseModel):
    """
    TableauMetricqueryserviceTypesV1VizStateSpecification
    """ # noqa: E501
    viz_state_string: Optional[StrictStr] = None
    __properties: ClassVar[List[str]] = ["viz_state_string"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "viz_state_string": obj.get("viz_state_string")
        })
        return _obj
