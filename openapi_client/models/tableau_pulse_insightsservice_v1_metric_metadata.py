...
class TableauPulseInsightsserviceV1MetricMetadata(BaseModel):
    """
    TableauPulseInsightsserviceV1MetricMetadata
    """ # noqa: E501
    name: Optional[StrictStr] = None
    metric_id: Optional[StrictStr] = None
    definition_id: Optional[StrictStr] = None
    __properties: ClassVar[List[str]] = ["name", "metric_id", "definition_id"]
