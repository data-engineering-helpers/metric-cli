...
class TableauAnalyticsextensionsV1ConnectionMapping(BaseModel):
    """
    TableauAnalyticsextensionsV1ConnectionMapping
    """ # noqa: E501
    workbook_luid: Optional[StrictStr] = None
    connection_luid: Optional[StrictStr] = None
    __properties: ClassVar[List[str]] = ["workbook_luid", "connection_luid"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "workbook_luid": obj.get("workbook_luid"),
