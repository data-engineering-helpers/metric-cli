...
class TableauPulseSubscriptionserviceV1CreateSubscriptionResponse(BaseModel):
    """
    TableauPulseSubscriptionserviceV1CreateSubscriptionResponse
    """ # noqa: E501
    subscription: Optional[TableauPulseSubscriptionserviceTypesV1Subscription] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "subscription": TableauPulseSubscriptionserviceTypesV1Subscription.from_dict(obj["subscription"]) if obj.get("subscription") is not None else None
        })
        return _obj
