...
class TableauPulseInsightsserviceV1RowEntryResult(BaseModel):
    """
    TableauPulseInsightsserviceV1RowEntryResult
    """ # noqa: E501
    value: Optional[TableauPulseInsightsserviceV1RowEntry] = None
    error: Optional[TableauPulseInsightsserviceV1Error] = None
    __properties: ClassVar[List[str]] = ["value", "error"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "value": TableauPulseInsightsserviceV1RowEntry.from_dict(obj["value"]) if obj.get("value") is not None else None,
