...
class TableauNlpLensPublicrestV1ValueSynonym(BaseModel):
    """
    TableauNlpLensPublicrestV1ValueSynonym
    """ # noqa: E501
    value: Optional[StrictStr] = Field(default=None, description="Original value")
    synonyms: Optional[List[StrictStr]] = None
    __properties: ClassVar[List[str]] = ["value", "synonyms"]
