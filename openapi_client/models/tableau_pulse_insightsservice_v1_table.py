...
class TableauPulseInsightsserviceV1Table(BaseModel):
    """
    TableauPulseInsightsserviceV1Table
    """ # noqa: E501
    columns: Optional[List[TableauPulseInsightsserviceV1ColumnInfo]] = None
    rows: Optional[List[TableauPulseInsightsserviceV1Row]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "columns": [TableauPulseInsightsserviceV1ColumnInfo.from_dict(_item) for _item in obj["columns"]] if obj.get("columns") is not None else None,
            "rows": [TableauPulseInsightsserviceV1Row.from_dict(_item) for _item in obj["rows"]] if obj.get("rows") is not None else None
        })
        return _obj
