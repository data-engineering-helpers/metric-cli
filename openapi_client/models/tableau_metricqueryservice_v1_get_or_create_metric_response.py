...
class TableauMetricqueryserviceV1GetOrCreateMetricResponse(BaseModel):
    """
    TableauMetricqueryserviceV1GetOrCreateMetricResponse
    """ # noqa: E501
    metric: Optional[TableauMetricqueryserviceTypesV1Metric] = None
    is_metric_created: Optional[StrictBool] = None
    __properties: ClassVar[List[str]] = ["metric", "is_metric_created"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "metric": TableauMetricqueryserviceTypesV1Metric.from_dict(obj["metric"]) if obj.get("metric") is not None else None,
            "is_metric_created": obj.get("is_metric_created")
        })
        return _obj
