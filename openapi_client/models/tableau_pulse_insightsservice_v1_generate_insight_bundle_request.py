...
class TableauPulseInsightsserviceV1GenerateInsightBundleRequest(BaseModel):
    """
    TableauPulseInsightsserviceV1GenerateInsightBundleRequest
    """ # noqa: E501
    version: Optional[StrictInt] = None
    options: Optional[TableauPulseInsightsserviceV1InsightBundleOptions] = None
    input: Optional[TableauPulseInsightsserviceV1InsightBundleInput] = None
    __properties: ClassVar[List[str]] = ["version", "options", "input"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "options": TableauPulseInsightsserviceV1InsightBundleOptions.from_dict(obj["options"]) if obj.get("options") is not None else None,
            "input": TableauPulseInsightsserviceV1InsightBundleInput.from_dict(obj["input"]) if obj.get("input") is not None else None
        })
        return _obj
