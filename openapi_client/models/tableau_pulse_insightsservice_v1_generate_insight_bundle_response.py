...
class TableauPulseInsightsserviceV1GenerateInsightBundleResponse(BaseModel):
    """
    TableauPulseInsightsserviceV1GenerateInsightBundleResponse
    """ # noqa: E501
    result: Optional[TableauPulseInsightsserviceV1InsightBundle] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "result": TableauPulseInsightsserviceV1InsightBundle.from_dict(obj["result"]) if obj.get("result") is not None else None,
