...
class TableauEventserviceV1PublishRequest(BaseModel):
    """
    TableauEventserviceV1PublishRequest
    """ # noqa: E501
    service: Optional[StrictStr] = None
    event: Optional[TableauEventserviceV1EventInput] = None
    __properties: ClassVar[List[str]] = ["service", "event"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "event": TableauEventserviceV1EventInput.from_dict(obj["event"]) if obj.get("event") is not None else None
        })
        return _obj
