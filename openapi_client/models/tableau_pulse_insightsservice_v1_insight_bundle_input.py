...
class TableauPulseInsightsserviceV1InsightBundleInput(BaseModel):
    """
    TableauPulseInsightsserviceV1InsightBundleInput
    """ # noqa: E501
    metadata: Optional[TableauPulseInsightsserviceV1MetricMetadata] = None
    metric: Optional[TableauPulseInsightsserviceV1InputMetric] = None
    __properties: ClassVar[List[str]] = ["metadata", "metric"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "metadata": TableauPulseInsightsserviceV1MetricMetadata.from_dict(obj["metadata"]) if obj.get("metadata") is not None else None,
            "metric": TableauPulseInsightsserviceV1InputMetric.from_dict(obj["metric"]) if obj.get("metric") is not None else None
        })
        return _obj
