...
class TableauAuthnV1ListIdentityPoolsResponse(BaseModel):
    """
    TableauAuthnV1ListIdentityPoolsResponse
    """ # noqa: E501
    pools: Optional[List[TableauAuthnV1IdentityPool]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "pools": [TableauAuthnV1IdentityPool.from_dict(_item) for _item in obj["pools"]] if obj.get("pools") is not None else None
        })
        return _obj
