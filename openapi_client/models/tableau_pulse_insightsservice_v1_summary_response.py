...
class TableauPulseInsightsserviceV1SummaryResponse(BaseModel):
    """
    TableauPulseInsightsserviceV1SummaryResponse
    """ # noqa: E501
    result: Optional[TableauPulseInsightsserviceV1Summary] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "result": TableauPulseInsightsserviceV1Summary.from_dict(obj["result"]) if obj.get("result") is not None else None,
