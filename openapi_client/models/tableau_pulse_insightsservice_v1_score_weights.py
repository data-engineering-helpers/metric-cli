...
class TableauPulseInsightsserviceV1ScoreWeights(BaseModel):
    """
    TableauPulseInsightsserviceV1ScoreWeights
    """ # noqa: E501
    impact_score: Optional[Union[StrictFloat, StrictInt]] = None
    relevance_score: Optional[Union[StrictFloat, StrictInt]] = None
    certainty_score: Optional[Union[StrictFloat, StrictInt]] = None
    __properties: ClassVar[List[str]] = ["impact_score", "relevance_score", "certainty_score"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "certainty_score": obj.get("certainty_score")
        })
        return _obj
