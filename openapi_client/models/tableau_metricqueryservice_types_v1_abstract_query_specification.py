...
class TableauMetricqueryserviceTypesV1AbstractQuerySpecification(BaseModel):
    """
    TableauMetricqueryserviceTypesV1AbstractQuerySpecification
    """ # noqa: E501
    abstract_query_string: Optional[StrictStr] = None
    __properties: ClassVar[List[str]] = ["abstract_query_string"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "abstract_query_string": obj.get("abstract_query_string")
        })
        return _obj
