...
class TableauPulseInsightsserviceV1Summary(BaseModel):
    """
    ...
    last_attempted_timestamp: Optional[StrictStr] = None
    __properties: ClassVar[List[str]] = ["id", "markup", "viz", "generation_id", "timestamp", "last_attempted_timestamp"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "last_attempted_timestamp": obj.get("last_attempted_timestamp")
        })
        return _obj
