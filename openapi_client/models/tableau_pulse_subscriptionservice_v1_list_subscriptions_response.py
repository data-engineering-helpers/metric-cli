...
class TableauPulseSubscriptionserviceV1ListSubscriptionsResponse(BaseModel):
    """
    TableauPulseSubscriptionserviceV1ListSubscriptionsResponse
    """ # noqa: E501
    subscriptions: Optional[List[TableauPulseSubscriptionserviceTypesV1Subscription]] = None
    next_page_token: Optional[StrictStr] = None
    __properties: ClassVar[List[str]] = ["subscriptions", "next_page_token"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "subscriptions": [TableauPulseSubscriptionserviceTypesV1Subscription.from_dict(_item) for _item in obj["subscriptions"]] if obj.get("subscriptions") is not None else None,
