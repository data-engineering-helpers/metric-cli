...
class TableauPulseInsightsserviceV1Row(BaseModel):
    """
    TableauPulseInsightsserviceV1Row
    """ # noqa: E501
    entries: Optional[List[TableauPulseInsightsserviceV1RowEntryResult]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "entries": [TableauPulseInsightsserviceV1RowEntryResult.from_dict(_item) for _item in obj["entries"]] if obj.get("entries") is not None else None
        })
        return _obj
