...
class TableauMetricqueryserviceV1GetEntitlementsResponse(BaseModel):
    """
    TableauMetricqueryserviceV1GetEntitlementsResponse
    """ # noqa: E501
    entitlements: Optional[List[TableauMetricqueryserviceTypesV1Entitlement]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "entitlements": [TableauMetricqueryserviceTypesV1Entitlement.from_dict(_item) for _item in obj["entitlements"]] if obj.get("entitlements") is not None else None
        })
        return _obj
