...
class TableauMetricqueryserviceTypesV1CategoricalValue(BaseModel):
    """
    TableauMetricqueryserviceTypesV1CategoricalValue
    """ # noqa: E501
    string_value: Optional[StrictStr] = None
    bool_value: Optional[StrictBool] = None
    null_value: Optional[StrictStr] = None
    __properties: ClassVar[List[str]] = ["string_value", "bool_value", "null_value"]
