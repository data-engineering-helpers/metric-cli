...
class TableauAuthnV1ListAuthConfigurationsResponse(BaseModel):
    """
    TableauAuthnV1ListAuthConfigurationsResponse
    """ # noqa: E501
    instances: Optional[List[TableauAuthnV1AuthConfiguration]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "instances": [TableauAuthnV1AuthConfiguration.from_dict(_item) for _item in obj["instances"]] if obj.get("instances") is not None else None
        })
        return _obj
