...
class TableauMetricqueryserviceTypesV1MetricGoals(BaseModel):
    """
    TableauMetricqueryserviceTypesV1MetricGoals
    """ # noqa: E501
    target: Optional[TableauMetricqueryserviceTypesV1TargetValueGoal] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "target": TableauMetricqueryserviceTypesV1TargetValueGoal.from_dict(obj["target"]) if obj.get("target") is not None else None
        })
        return _obj
