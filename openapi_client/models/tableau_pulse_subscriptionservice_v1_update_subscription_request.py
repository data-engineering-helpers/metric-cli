...
class TableauPulseSubscriptionserviceV1UpdateSubscriptionRequest(BaseModel):
    """
    TableauPulseSubscriptionserviceV1UpdateSubscriptionRequest
    """ # noqa: E501
    id: Optional[StrictStr] = None
    metric_id: Optional[StrictStr] = None
    follower: Optional[TableauPulseSubscriptionserviceTypesV1Follower] = None
    __properties: ClassVar[List[str]] = ["id", "metric_id", "follower"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "follower": TableauPulseSubscriptionserviceTypesV1Follower.from_dict(obj["follower"]) if obj.get("follower") is not None else None
        })
        return _obj
