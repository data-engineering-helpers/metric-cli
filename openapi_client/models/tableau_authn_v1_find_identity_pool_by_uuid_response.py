...
class TableauAuthnV1FindIdentityPoolByUuidResponse(BaseModel):
    """
    TableauAuthnV1FindIdentityPoolByUuidResponse
    """ # noqa: E501
    pool: Optional[TableauAuthnV1IdentityPool] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "pool": TableauAuthnV1IdentityPool.from_dict(obj["pool"]) if obj.get("pool") is not None else None
        })
        return _obj
