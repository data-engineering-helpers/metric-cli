...
class TableauMetricqueryserviceTypesV1RepresentationOptionsNumberUnits(BaseModel):
    """
    TableauMetricqueryserviceTypesV1RepresentationOptionsNumberUnits
    """ # noqa: E501
    singular_noun: Optional[StrictStr] = None
    plural_noun: Optional[StrictStr] = None
    __properties: ClassVar[List[str]] = ["singular_noun", "plural_noun"]
