...
class TableauNlpLensPublicrestV1ListLensesResponse(BaseModel):
    """
    TableauNlpLensPublicrestV1ListLensesResponse
    """ # noqa: E501
    lenses: Optional[List[TableauNlpLensPublicrestV1ListLensItem]] = None
    __properties: ClassVar[List[str]] = ["lenses"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "lenses": [TableauNlpLensPublicrestV1ListLensItem.from_dict(_item) for _item in obj["lenses"]] if obj.get("lenses") is not None else None
        })
        return _obj
