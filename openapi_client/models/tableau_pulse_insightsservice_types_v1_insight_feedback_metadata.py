...
class TableauPulseInsightsserviceTypesV1InsightFeedbackMetadata(BaseModel):
    """
    TableauPulseInsightsserviceTypesV1InsightFeedbackMetadata
    """ # noqa: E501
    type: Optional[StrictStr] = None
    score: Optional[Union[StrictFloat, StrictInt]] = None
    dimension_hash: Optional[StrictStr] = None
    __properties: ClassVar[List[str]] = ["type", "score", "dimension_hash"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "type": obj.get("type"),
            "score": obj.get("score"),
            "dimension_hash": obj.get("dimension_hash")
        })
        return _obj
