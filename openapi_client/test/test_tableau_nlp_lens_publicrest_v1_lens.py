...
class TestTableauNlpLensPublicrestV1Lens(unittest.TestCase):
    """TableauNlpLensPublicrestV1Lens unit test stubs"""
    ...
    def make_instance(self, include_optional) -> TableauNlpLensPublicrestV1Lens:
        """Test TableauNlpLensPublicrestV1Lens
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `TableauNlpLensPublicrestV1Lens`
        """
        model = TableauNlpLensPublicrestV1Lens()
        if include_optional:
            return TableauNlpLensPublicrestV1Lens(
                id = '',
                name = '',
                site_id = '',
                datasource_id = '',
    ...
    def testTableauNlpLensPublicrestV1Lens(self):
        """Test TableauNlpLensPublicrestV1Lens"""
