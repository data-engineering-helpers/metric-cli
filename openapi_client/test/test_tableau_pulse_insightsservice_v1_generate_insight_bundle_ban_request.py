...
class TestTableauPulseInsightsserviceV1GenerateInsightBundleBANRequest(unittest.TestCase):
    """TableauPulseInsightsserviceV1GenerateInsightBundleBANRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> TableauPulseInsightsserviceV1GenerateInsightBundleBANRequest:
        """Test TableauPulseInsightsserviceV1GenerateInsightBundleBANRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `TableauPulseInsightsserviceV1GenerateInsightBundleBANRequest`
        """
        model = TableauPulseInsightsserviceV1GenerateInsightBundleBANRequest()
        if include_optional:
            return TableauPulseInsightsserviceV1GenerateInsightBundleBANRequest(
    ...
    def testTableauPulseInsightsserviceV1GenerateInsightBundleBANRequest(self):
        """Test TableauPulseInsightsserviceV1GenerateInsightBundleBANRequest"""
