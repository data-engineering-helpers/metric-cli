...
class TestTableauPulseInsightsserviceV1InputMetric(unittest.TestCase):
    """TableauPulseInsightsserviceV1InputMetric unit test stubs"""
    ...
    def make_instance(self, include_optional) -> TableauPulseInsightsserviceV1InputMetric:
        """Test TableauPulseInsightsserviceV1InputMetric
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `TableauPulseInsightsserviceV1InputMetric`
        """
        model = TableauPulseInsightsserviceV1InputMetric()
        if include_optional:
            return TableauPulseInsightsserviceV1InputMetric(
    ...
    def testTableauPulseInsightsserviceV1InputMetric(self):
        """Test TableauPulseInsightsserviceV1InputMetric"""
