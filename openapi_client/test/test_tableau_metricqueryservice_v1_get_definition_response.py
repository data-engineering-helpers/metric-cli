...
class TestTableauMetricqueryserviceV1GetDefinitionResponse(unittest.TestCase):
    """TableauMetricqueryserviceV1GetDefinitionResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> TableauMetricqueryserviceV1GetDefinitionResponse:
        """Test TableauMetricqueryserviceV1GetDefinitionResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `TableauMetricqueryserviceV1GetDefinitionResponse`
        """
        model = TableauMetricqueryserviceV1GetDefinitionResponse()
        if include_optional:
            return TableauMetricqueryserviceV1GetDefinitionResponse(
    ...
    def testTableauMetricqueryserviceV1GetDefinitionResponse(self):
        """Test TableauMetricqueryserviceV1GetDefinitionResponse"""
