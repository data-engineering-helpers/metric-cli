...
class TestTableauPulseInsightsserviceV1GenerateInsightBundleResponse(unittest.TestCase):
    """TableauPulseInsightsserviceV1GenerateInsightBundleResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> TableauPulseInsightsserviceV1GenerateInsightBundleResponse:
        """Test TableauPulseInsightsserviceV1GenerateInsightBundleResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `TableauPulseInsightsserviceV1GenerateInsightBundleResponse`
        """
        model = TableauPulseInsightsserviceV1GenerateInsightBundleResponse()
        if include_optional:
            return TableauPulseInsightsserviceV1GenerateInsightBundleResponse(
    ...
    def testTableauPulseInsightsserviceV1GenerateInsightBundleResponse(self):
        """Test TableauPulseInsightsserviceV1GenerateInsightBundleResponse"""
