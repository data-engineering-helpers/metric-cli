...
class TestTableauMetricqueryserviceV1BatchGetMetricsResponse(unittest.TestCase):
    """TableauMetricqueryserviceV1BatchGetMetricsResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> TableauMetricqueryserviceV1BatchGetMetricsResponse:
        """Test TableauMetricqueryserviceV1BatchGetMetricsResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `TableauMetricqueryserviceV1BatchGetMetricsResponse`
        """
        model = TableauMetricqueryserviceV1BatchGetMetricsResponse()
        if include_optional:
            return TableauMetricqueryserviceV1BatchGetMetricsResponse(
                metrics = [
    ...
    def testTableauMetricqueryserviceV1BatchGetMetricsResponse(self):
        """Test TableauMetricqueryserviceV1BatchGetMetricsResponse"""
