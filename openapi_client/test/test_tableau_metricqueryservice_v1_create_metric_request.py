...
class TestTableauMetricqueryserviceV1CreateMetricRequest(unittest.TestCase):
    """TableauMetricqueryserviceV1CreateMetricRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> TableauMetricqueryserviceV1CreateMetricRequest:
        """Test TableauMetricqueryserviceV1CreateMetricRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `TableauMetricqueryserviceV1CreateMetricRequest`
        """
        model = TableauMetricqueryserviceV1CreateMetricRequest()
        if include_optional:
            return TableauMetricqueryserviceV1CreateMetricRequest(
                definition_id = '',
    ...
    def testTableauMetricqueryserviceV1CreateMetricRequest(self):
        """Test TableauMetricqueryserviceV1CreateMetricRequest"""
