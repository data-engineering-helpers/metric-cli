...
class TestTableauPulseInsightsserviceV1GenerateInsightBundleDetailRequest(unittest.TestCase):
    """TableauPulseInsightsserviceV1GenerateInsightBundleDetailRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> TableauPulseInsightsserviceV1GenerateInsightBundleDetailRequest:
        """Test TableauPulseInsightsserviceV1GenerateInsightBundleDetailRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `TableauPulseInsightsserviceV1GenerateInsightBundleDetailRequest`
        """
        model = TableauPulseInsightsserviceV1GenerateInsightBundleDetailRequest()
        if include_optional:
            return TableauPulseInsightsserviceV1GenerateInsightBundleDetailRequest(
    ...
    def testTableauPulseInsightsserviceV1GenerateInsightBundleDetailRequest(self):
        """Test TableauPulseInsightsserviceV1GenerateInsightBundleDetailRequest"""
