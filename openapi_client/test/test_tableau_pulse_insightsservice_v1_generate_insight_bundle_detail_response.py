...
class TestTableauPulseInsightsserviceV1GenerateInsightBundleDetailResponse(unittest.TestCase):
    """TableauPulseInsightsserviceV1GenerateInsightBundleDetailResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> TableauPulseInsightsserviceV1GenerateInsightBundleDetailResponse:
        """Test TableauPulseInsightsserviceV1GenerateInsightBundleDetailResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `TableauPulseInsightsserviceV1GenerateInsightBundleDetailResponse`
        """
        model = TableauPulseInsightsserviceV1GenerateInsightBundleDetailResponse()
        if include_optional:
            return TableauPulseInsightsserviceV1GenerateInsightBundleDetailResponse(
    ...
    def testTableauPulseInsightsserviceV1GenerateInsightBundleDetailResponse(self):
        """Test TableauPulseInsightsserviceV1GenerateInsightBundleDetailResponse"""
