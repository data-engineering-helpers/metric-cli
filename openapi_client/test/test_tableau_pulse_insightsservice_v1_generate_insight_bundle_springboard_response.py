...
class TestTableauPulseInsightsserviceV1GenerateInsightBundleSpringboardResponse(unittest.TestCase):
    """TableauPulseInsightsserviceV1GenerateInsightBundleSpringboardResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> TableauPulseInsightsserviceV1GenerateInsightBundleSpringboardResponse:
        """Test TableauPulseInsightsserviceV1GenerateInsightBundleSpringboardResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `TableauPulseInsightsserviceV1GenerateInsightBundleSpringboardResponse`
        """
        model = TableauPulseInsightsserviceV1GenerateInsightBundleSpringboardResponse()
        if include_optional:
            return TableauPulseInsightsserviceV1GenerateInsightBundleSpringboardResponse(
    ...
    def testTableauPulseInsightsserviceV1GenerateInsightBundleSpringboardResponse(self):
        """Test TableauPulseInsightsserviceV1GenerateInsightBundleSpringboardResponse"""
