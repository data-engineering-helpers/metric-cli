...
class TestTableauPulseSubscriptionserviceV1UpdateUserPreferencesResponse(unittest.TestCase):
    """TableauPulseSubscriptionserviceV1UpdateUserPreferencesResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> TableauPulseSubscriptionserviceV1UpdateUserPreferencesResponse:
        """Test TableauPulseSubscriptionserviceV1UpdateUserPreferencesResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `TableauPulseSubscriptionserviceV1UpdateUserPreferencesResponse`
        """
        model = TableauPulseSubscriptionserviceV1UpdateUserPreferencesResponse()
        if include_optional:
            return TableauPulseSubscriptionserviceV1UpdateUserPreferencesResponse(
    ...
    def testTableauPulseSubscriptionserviceV1UpdateUserPreferencesResponse(self):
        """Test TableauPulseSubscriptionserviceV1UpdateUserPreferencesResponse"""
