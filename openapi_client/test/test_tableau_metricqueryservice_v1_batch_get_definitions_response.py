...
class TestTableauMetricqueryserviceV1BatchGetDefinitionsResponse(unittest.TestCase):
    """TableauMetricqueryserviceV1BatchGetDefinitionsResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> TableauMetricqueryserviceV1BatchGetDefinitionsResponse:
        """Test TableauMetricqueryserviceV1BatchGetDefinitionsResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `TableauMetricqueryserviceV1BatchGetDefinitionsResponse`
        """
        model = TableauMetricqueryserviceV1BatchGetDefinitionsResponse()
        if include_optional:
            return TableauMetricqueryserviceV1BatchGetDefinitionsResponse(
                definitions = [
    ...
    def testTableauMetricqueryserviceV1BatchGetDefinitionsResponse(self):
        """Test TableauMetricqueryserviceV1BatchGetDefinitionsResponse"""
