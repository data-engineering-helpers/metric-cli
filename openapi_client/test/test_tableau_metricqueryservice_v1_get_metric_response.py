...
class TestTableauMetricqueryserviceV1GetMetricResponse(unittest.TestCase):
    """TableauMetricqueryserviceV1GetMetricResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> TableauMetricqueryserviceV1GetMetricResponse:
        """Test TableauMetricqueryserviceV1GetMetricResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `TableauMetricqueryserviceV1GetMetricResponse`
        """
        model = TableauMetricqueryserviceV1GetMetricResponse()
        if include_optional:
            return TableauMetricqueryserviceV1GetMetricResponse(
    ...
    def testTableauMetricqueryserviceV1GetMetricResponse(self):
        """Test TableauMetricqueryserviceV1GetMetricResponse"""
