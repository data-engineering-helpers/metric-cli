...
class TestTableauMetricqueryserviceV1ListMetricsResponse(unittest.TestCase):
    """TableauMetricqueryserviceV1ListMetricsResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> TableauMetricqueryserviceV1ListMetricsResponse:
        """Test TableauMetricqueryserviceV1ListMetricsResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `TableauMetricqueryserviceV1ListMetricsResponse`
        """
        model = TableauMetricqueryserviceV1ListMetricsResponse()
        if include_optional:
            return TableauMetricqueryserviceV1ListMetricsResponse(
                metrics = [
    ...
    def testTableauMetricqueryserviceV1ListMetricsResponse(self):
        """Test TableauMetricqueryserviceV1ListMetricsResponse"""
