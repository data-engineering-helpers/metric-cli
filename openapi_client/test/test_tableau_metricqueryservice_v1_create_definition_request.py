...
class TestTableauMetricqueryserviceV1CreateDefinitionRequest(unittest.TestCase):
    """TableauMetricqueryserviceV1CreateDefinitionRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> TableauMetricqueryserviceV1CreateDefinitionRequest:
        """Test TableauMetricqueryserviceV1CreateDefinitionRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `TableauMetricqueryserviceV1CreateDefinitionRequest`
        """
        model = TableauMetricqueryserviceV1CreateDefinitionRequest()
        if include_optional:
            return TableauMetricqueryserviceV1CreateDefinitionRequest(
                name = '',
                description = '',
    ...
    def testTableauMetricqueryserviceV1CreateDefinitionRequest(self):
        """Test TableauMetricqueryserviceV1CreateDefinitionRequest"""
