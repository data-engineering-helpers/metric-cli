...
class TestTableauPulseInsightsserviceV1GenerateInsightBundleRequest(unittest.TestCase):
    """TableauPulseInsightsserviceV1GenerateInsightBundleRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> TableauPulseInsightsserviceV1GenerateInsightBundleRequest:
        """Test TableauPulseInsightsserviceV1GenerateInsightBundleRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `TableauPulseInsightsserviceV1GenerateInsightBundleRequest`
        """
        model = TableauPulseInsightsserviceV1GenerateInsightBundleRequest()
        if include_optional:
            return TableauPulseInsightsserviceV1GenerateInsightBundleRequest(
                version = 56,
    ...
    def testTableauPulseInsightsserviceV1GenerateInsightBundleRequest(self):
        """Test TableauPulseInsightsserviceV1GenerateInsightBundleRequest"""
