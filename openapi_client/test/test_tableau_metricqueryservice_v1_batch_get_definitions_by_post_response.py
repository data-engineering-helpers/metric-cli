...
class TestTableauMetricqueryserviceV1BatchGetDefinitionsByPostResponse(unittest.TestCase):
    """TableauMetricqueryserviceV1BatchGetDefinitionsByPostResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> TableauMetricqueryserviceV1BatchGetDefinitionsByPostResponse:
        """Test TableauMetricqueryserviceV1BatchGetDefinitionsByPostResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `TableauMetricqueryserviceV1BatchGetDefinitionsByPostResponse`
        """
        model = TableauMetricqueryserviceV1BatchGetDefinitionsByPostResponse()
        if include_optional:
            return TableauMetricqueryserviceV1BatchGetDefinitionsByPostResponse(
                definitions = [
    ...
    def testTableauMetricqueryserviceV1BatchGetDefinitionsByPostResponse(self):
        """Test TableauMetricqueryserviceV1BatchGetDefinitionsByPostResponse"""
