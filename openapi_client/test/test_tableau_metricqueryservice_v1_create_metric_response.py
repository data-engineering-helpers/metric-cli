...
class TestTableauMetricqueryserviceV1CreateMetricResponse(unittest.TestCase):
    """TableauMetricqueryserviceV1CreateMetricResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> TableauMetricqueryserviceV1CreateMetricResponse:
        """Test TableauMetricqueryserviceV1CreateMetricResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `TableauMetricqueryserviceV1CreateMetricResponse`
        """
        model = TableauMetricqueryserviceV1CreateMetricResponse()
        if include_optional:
            return TableauMetricqueryserviceV1CreateMetricResponse(
    ...
    def testTableauMetricqueryserviceV1CreateMetricResponse(self):
        """Test TableauMetricqueryserviceV1CreateMetricResponse"""
