...
class TestTableauMetricqueryserviceTypesV1Definition(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> MetricDefinition:
        ...
        # uncomment below to create an instance of `TableauMetricqueryserviceTypesV1Definition`
        """
        model = TableauMetricqueryserviceTypesV1Definition()
        if include_optional:
            return TableauMetricqueryserviceTypesV1Definition(
    ...
    def testTableauMetricqueryserviceTypesV1Definition(self):
        """Test TableauMetricqueryserviceTypesV1Definition"""
