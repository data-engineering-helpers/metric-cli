...
class TestTableauMetricqueryserviceV1CreateDefinitionResponse(unittest.TestCase):
    """TableauMetricqueryserviceV1CreateDefinitionResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> TableauMetricqueryserviceV1CreateDefinitionResponse:
        """Test TableauMetricqueryserviceV1CreateDefinitionResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `TableauMetricqueryserviceV1CreateDefinitionResponse`
        """
        model = TableauMetricqueryserviceV1CreateDefinitionResponse()
        if include_optional:
            return TableauMetricqueryserviceV1CreateDefinitionResponse(
                definition = openapi_client.models.tableau/metricqueryservice/types/v1/definition.tableau.metricqueryservice.types.v1.Definition(
    ...
    def testTableauMetricqueryserviceV1CreateDefinitionResponse(self):
        """Test TableauMetricqueryserviceV1CreateDefinitionResponse"""
