...
class TestTableauMetricqueryserviceV1UpdateDefinitionResponse(unittest.TestCase):
    """TableauMetricqueryserviceV1UpdateDefinitionResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> TableauMetricqueryserviceV1UpdateDefinitionResponse:
        """Test TableauMetricqueryserviceV1UpdateDefinitionResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `TableauMetricqueryserviceV1UpdateDefinitionResponse`
        """
        model = TableauMetricqueryserviceV1UpdateDefinitionResponse()
        if include_optional:
            return TableauMetricqueryserviceV1UpdateDefinitionResponse(
    ...
    def testTableauMetricqueryserviceV1UpdateDefinitionResponse(self):
        """Test TableauMetricqueryserviceV1UpdateDefinitionResponse"""
