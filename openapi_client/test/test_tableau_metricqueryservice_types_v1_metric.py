...
class TestTableauMetricqueryserviceTypesV1Metric(unittest.TestCase):
    """TableauMetricqueryserviceTypesV1Metric unit test stubs"""
    ...
    def make_instance(self, include_optional) -> TableauMetricqueryserviceTypesV1Metric:
        """Test TableauMetricqueryserviceTypesV1Metric
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `TableauMetricqueryserviceTypesV1Metric`
        """
        model = TableauMetricqueryserviceTypesV1Metric()
        if include_optional:
            return TableauMetricqueryserviceTypesV1Metric(
                id = '',
    ...
    def testTableauMetricqueryserviceTypesV1Metric(self):
        """Test TableauMetricqueryserviceTypesV1Metric"""
