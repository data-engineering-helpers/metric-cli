...
class TestTableauNlpLensPublicrestV1GetLensResponse(unittest.TestCase):
    """TableauNlpLensPublicrestV1GetLensResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> TableauNlpLensPublicrestV1GetLensResponse:
        """Test TableauNlpLensPublicrestV1GetLensResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `TableauNlpLensPublicrestV1GetLensResponse`
        """
        model = TableauNlpLensPublicrestV1GetLensResponse()
        if include_optional:
            return TableauNlpLensPublicrestV1GetLensResponse(
    ...
    def testTableauNlpLensPublicrestV1GetLensResponse(self):
        """Test TableauNlpLensPublicrestV1GetLensResponse"""
