...
class TestTableauPulseInsightsserviceV1GenerateInsightBundleSpringboardRequest(unittest.TestCase):
    """TableauPulseInsightsserviceV1GenerateInsightBundleSpringboardRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> TableauPulseInsightsserviceV1GenerateInsightBundleSpringboardRequest:
        """Test TableauPulseInsightsserviceV1GenerateInsightBundleSpringboardRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `TableauPulseInsightsserviceV1GenerateInsightBundleSpringboardRequest`
        """
        model = TableauPulseInsightsserviceV1GenerateInsightBundleSpringboardRequest()
        if include_optional:
            return TableauPulseInsightsserviceV1GenerateInsightBundleSpringboardRequest(
                bundle_request = openapi_client.models.tableau/pulse/insightsservice/v1/generate_insight_bundle_request.tableau.pulse.insightsservice.v1.GenerateInsightBundleRequest(
                    version = 56, 
                    options = openapi_client.models.tableau/pulse/insightsservice/v1/insight_bundle_options.tableau.pulse.insightsservice.v1.InsightBundleOptions(
                    ...
                    input = openapi_client.models.tableau/pulse/insightsservice/v1/insight_bundle_input.tableau.pulse.insightsservice.v1.InsightBundleInput(
    ...
    def testTableauPulseInsightsserviceV1GenerateInsightBundleSpringboardRequest(self):
        """Test TableauPulseInsightsserviceV1GenerateInsightBundleSpringboardRequest"""
